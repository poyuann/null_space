...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    //    subscriber    //
    ros::Subscriber host_sub = nh.subscribe<geometry_msgs::PoseStamped>("/MAV6/mavros/local_position/pose_initialized", 10, host_pos);
    
    //    publisher    //
    ros::Publisher desired_pos_pub = nh.advertise<geometry_msgs::PoseStamped>("/leader_pose", 10);
